/*
 * NumberTile -luokan hheader tiedosto. GameBoard luokka käyttää pelissä
 * luokan NumberTile olioita. Nämä ovat siis pelissä siirreltäviä laattoja.
 */
...
public:
    ...
    // Palauttaa number tilen arvon.
    int get_value_();

    // Asettaa number tilen arvon ja siitä saadun pistemäärän nollaksi.
    void reset();

    // Palauttaa number tilestä saadun pistemäärän.
    int get_points_();
